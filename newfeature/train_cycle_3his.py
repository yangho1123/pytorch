...
from train_network_new import train_network
from evaluate_network_random import evaluate_latest_vs_random, update_best_player, EN_GAME_COUNT
from load_data import load_data, load_data_folders, prepare_data, write_prepared_data, load_data_from_file
import time
...
def prepare_and_write():
    history = load_data_folders()   #載入歷史資料(筆數)
...
if __name__ == '__main__':
    ...
    for i in range(train_epochs):
        ...
        total_wins, total_games, win_rate = evaluate_latest_vs_random(evaluate_processes)
